...
class forward_iterator {
 ...
 private:
  explicit forward_iterator(forward_iterator<type_of_t<java::lang::Object>>&& iter)
  : iter_(std::move(iter))
  {}
 ...
 private:
  forward_iterator<type_of_t<java::lang::Object>> iter_;
};
...
class bidirectional_iterator {
 ...
 private:
  explicit bidirectional_iterator(bidirectional_iterator<type_of_t<java::lang::Object>>&& iter)
  : iter_(std::move(iter))
  {}
 ...
 private:
  bidirectional_iterator<type_of_t<java::lang::Object>> iter_;
};
