...
public interface MethodModel {
     ...
     */
    public static class BaseMethodGenerics {
        private static final String ENABLER_TEMPLATE_ARGUMENT = "__Enabler__";

        public BaseMethodGenerics(Map<String, BoundTemplate> methodGenerics, List<Type> argumentTypes) {
        ...
        public BaseMethodGenerics(Context ctx, Collection<String> variables, Map<String, String> rawMethodGenerics, BoundTemplate.ClassBinding<ClassType> thisType, List<Type> argumentTypes) {
         ...
         *
         * @return Map of generics, with any variable resolved to exclude
         * variables in the method generics.
         */
        ...
        public boolean equals(Object obj) {
            ...
            final BaseMethodGenerics other = (BaseMethodGenerics) obj;
         ...
         * resolved.
         * @throws IllegalStateException if any of the variables require
         ...
         *
         * The returned map should have no dependencies on generics declared at
         * the function level.
         *
         * @param map Raw mapping of method generics.
         * @return Same map, but any mappings to variables in the mapping have
         * been resolved.
         */
         ...
         *
         * Note: this method is called from the constructor. It requires that
         * the {@link #methodGenerics methodGenerics} variable is initialized
         * prior to being invoked.
         *
         * @param type A type which may or may not be using any method generics.
         * @return Multimap containing all method generics provided by this
         * type.
         */
         ...
         *
         * Each generic has a name (the key of the map) and constraints (the
         * value of the map).
         */
        ...
        /**
         * Describes the variable that is used for any argument that supplies
         * the input to compute method generics. Empty optionals describe
         * arguments that do no aid in generics resolution.
         */
         ...
         *
         * Note that this list will contain {@code null} when there is no
         * default for an argument.
         */
        private final List<String> functionGenericsDefault;
        /**
         * Variable map that rebinds the supplied variable names to their
     ...
     */
    public static class SimpleMethodModel extends BaseMethodGenerics implements MethodModel {
        ...
        public SimpleMethodModel(ClassType declaringClass, BoundTemplate.ClassBinding<? extends ClassType> argumentDeclaringClass, String name, Includes includes, Set<Type> declarationTypes, Set<Type> implementationTypes, Type returnType, List<Type> argumentTypes, List<String> argumentNames, String body, boolean staticVar, boolean virtualVar, boolean pureVirtualVar, boolean overrideVar, boolean constVar, boolean finalVar, String inline, Object noexcept, Visibility visibility, String docString) {
            super(EMPTY_MAP, argumentTypes); // XXX add as constructor argument!
